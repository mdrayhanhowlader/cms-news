...
class TabletMostViewed extends GetView<DesktopHomeController> {
  TabletMostViewed({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    final titleWidth = Get.width * 0.6; // Adjust as needed
    ...
    return CarouselSlider.builder(
      ...
      itemBuilder: (context, index, realindex) {
        ...
        return MouseRegion(
          ...
          child: Container(
            width: Get.width * 0.9, // 90% width for tablet
